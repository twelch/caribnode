...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tool.icon'
        db.add_column(u'tools_tool', 'icon', self.gf('django.db.models.fields.CharField')(default='/static/img/icon_38430_coral.png', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Tool.icon'
        db.delete_column(u'tools_tool', 'icon')
