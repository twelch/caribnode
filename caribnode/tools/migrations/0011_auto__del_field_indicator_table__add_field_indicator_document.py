...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Indicator.table'
        db.delete_column(u'tools_indicator', 'table')

        # Adding field 'Indicator.document'
        db.add_column(u'tools_indicator', 'document', self.gf('django.db.models.fields.related.ForeignKey')(default=24, related_name='document_indicator', to=orm['documents.Document']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Indicator.table'
        db.add_column(u'tools_indicator', 'table', self.gf('django.db.models.fields.CharField')(default=24, max_length=50), keep_default=False)

        # Deleting field 'Indicator.document'
        db.delete_column(u'tools_indicator', 'document_id')
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 20, 22, 34, 9, 942991)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 20, 22, 34, 9, 955246)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 20, 22, 34, 9, 954930)'}),
