...
class Migration(SchemaMigration):
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 20, 22, 41, 29, 567860)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 20, 22, 41, 29, 576129)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 20, 22, 41, 29, 575565)'}),
        ...
        u'tools.indicator': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'tools': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['tools.Tool']", 'symmetrical': 'False'}),
