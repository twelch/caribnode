...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Scale'
        db.create_table(u'tools_scale', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'tools', ['Scale'])

        # Removing M2M table for field tools on 'Indicator'
        db.delete_table('tools_indicator_tools')

        # Adding M2M table for field scales on 'Indicator'
        db.create_table(u'tools_indicator_scales', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('indicator', models.ForeignKey(orm[u'tools.indicator'], null=False)),
            ('scale', models.ForeignKey(orm[u'tools.scale'], null=False))
        ))
        db.create_unique(u'tools_indicator_scales', ['indicator_id', 'scale_id'])


    def backwards(self, orm):
        
        # Deleting model 'Scale'
        db.delete_table(u'tools_scale')

        # Adding M2M table for field tools on 'Indicator'
        db.create_table(u'tools_indicator_tools', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('indicator', models.ForeignKey(orm[u'tools.indicator'], null=False)),
            ('tool', models.ForeignKey(orm[u'tools.tool'], null=False))
        ))
        db.create_unique(u'tools_indicator_tools', ['indicator_id', 'tool_id'])

        # Removing M2M table for field scales on 'Indicator'
        db.delete_table('tools_indicator_scales')
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 20, 22, 52, 34, 423101)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 20, 22, 52, 34, 422161)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 20, 22, 52, 34, 421624)'}),
