...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Indicator.indi_type'
        db.add_column(u'tools_indicator', 'indi_type', self.gf('django.db.models.fields.CharField')(default='None', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Indicator.indi_type'
        db.delete_column(u'tools_indicator', 'indi_type')
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 21, 0, 40, 12, 465234)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 21, 0, 40, 12, 463139)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 21, 0, 40, 12, 462787)'}),
