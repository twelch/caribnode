...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Unit'
        db.create_table(u'tools_unit', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='unit_related', to=orm['tools.Unit'])),
            ('scale', self.gf('django.db.models.fields.related.ForeignKey')(related_name='unit_scale', to=orm['tools.Scale'])),
        ))
        db.send_create_signal(u'tools', ['Unit'])


    def backwards(self, orm):
        
        # Deleting model 'Unit'
        db.delete_table(u'tools_unit')
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 23, 20, 49, 9, 447696)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 23, 20, 49, 9, 440407)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 23, 20, 49, 9, 439885)'}),
        ...
        u'tools.unit': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'unit_related'", 'to': u"orm['tools.Unit']"}),
