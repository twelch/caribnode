...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Unit.parent'
        db.alter_column(u'tools_unit', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['tools.Unit']))


    def backwards(self, orm):
        
        # Changing field 'Unit.parent'
        db.alter_column(u'tools_unit', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(default='foo', to=orm['tools.Unit']))
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 23, 20, 53, 31, 269258)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 23, 20, 53, 31, 281584)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 23, 20, 53, 31, 281264)'}),
