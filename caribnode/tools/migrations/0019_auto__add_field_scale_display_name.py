...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Scale.display_name'
        db.add_column(u'tools_scale', 'display_name', self.gf('django.db.models.fields.CharField')(default='foo', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Scale.display_name'
        db.delete_column(u'tools_scale', 'display_name')
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 23, 22, 20, 53, 191200)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 23, 22, 20, 53, 190212)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 23, 22, 20, 53, 189527)'}),
