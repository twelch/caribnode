...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Tool.display_ame'
        db.delete_column(u'tools_tool', 'display_ame')

        # Adding field 'Tool.display_name'
        db.add_column(u'tools_tool', 'display_name', self.gf('django.db.models.fields.CharField')(default='foo', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Tool.display_ame'
        db.add_column(u'tools_tool', 'display_ame', self.gf('django.db.models.fields.CharField')(default='foo', max_length=100), keep_default=False)

        # Deleting field 'Tool.display_name'
        db.delete_column(u'tools_tool', 'display_name')
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 11, 15, 59, 16, 137103)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 11, 15, 59, 16, 136485)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 11, 15, 59, 16, 136164)'}),
