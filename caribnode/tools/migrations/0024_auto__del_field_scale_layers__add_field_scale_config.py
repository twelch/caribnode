...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Scale.layers'
        db.delete_column(u'tools_scale', 'layers')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Scale.layers'
        db.add_column(u'tools_scale', 'layers', self.gf('jsonfield.fields.JSONField')(null=True, blank=True), keep_default=False)
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 13, 16, 23, 2, 46746)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 13, 16, 23, 2, 48324)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 13, 16, 23, 2, 48022)'}),
