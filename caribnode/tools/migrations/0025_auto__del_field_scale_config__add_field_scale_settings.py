...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Scale.config'
        db.delete_column(u'tools_scale', 'config')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Scale.config'
        db.add_column(u'tools_scale', 'config', self.gf('jsonfield.fields.JSONField')(null=True, blank=True), keep_default=False)
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 13, 16, 38, 52, 818898)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 13, 16, 38, 52, 816912)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 13, 16, 38, 52, 816380)'}),
