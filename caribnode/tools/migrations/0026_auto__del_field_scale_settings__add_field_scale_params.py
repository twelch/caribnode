...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Scale.settings'
        db.delete_column(u'tools_scale', 'settings')

        # Adding field 'Scale.params'
        db.add_column(u'tools_scale', 'params', self.gf('jsonfield.fields.JSONField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Scale.settings'
        db.add_column(u'tools_scale', 'settings', self.gf('jsonfield.fields.JSONField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Scale.params'
        db.delete_column(u'tools_scale', 'params')
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 13, 16, 40, 27, 131158)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 13, 16, 40, 27, 127020)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 13, 16, 40, 27, 126738)'}),
