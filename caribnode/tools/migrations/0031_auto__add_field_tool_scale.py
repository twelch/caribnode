...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tool.scale'
        db.add_column(u'tools_tool', 'scale', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='tool_scale', to=orm['tools.Scale']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Tool.scale'
        db.delete_column(u'tools_tool', 'scale_id')
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 18, 22, 38, 21, 94157)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 18, 22, 38, 21, 77651)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 18, 22, 38, 21, 77331)'}),
        ...
        u'tools.indicator': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indi_type': ('django.db.models.fields.CharField', [], {'default': "'None'", 'max_length': '100'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
