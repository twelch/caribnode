...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Grade.color'
        db.add_column(u'tools_grade', 'color', self.gf('django.db.models.fields.CharField')(default='#000000', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Grade.color'
        db.delete_column(u'tools_grade', 'color')
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 22, 14, 44, 22, 906160)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 22, 14, 44, 22, 892635)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 22, 14, 44, 22, 892307)'}),
