...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'IndiGrade'
        db.create_table(u'tools_indigrade', (
            ...
            ('grade', self.gf('django.db.models.fields.related.ForeignKey')(related_name='', to=orm['tools.Grade'])),
        ))
        db.send_create_signal(u'tools', ['IndiGrade'])

        # Deleting field 'Grade.indicator'
        db.delete_column(u'tools_grade', 'indicator_id')

        # Deleting field 'Grade.description'
        db.delete_column(u'tools_grade', 'description')


    def backwards(self, orm):
        
        # Deleting model 'IndiGrade'
        db.delete_table(u'tools_indigrade')

        # Adding field 'Grade.indicator'
        db.add_column(u'tools_grade', 'indicator', self.gf('django.db.models.fields.related.ForeignKey')(default='foo', related_name='indicator_grade', to=orm['tools.Indicator']), keep_default=False)

        # Adding field 'Grade.description'
        db.add_column(u'tools_grade', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 23, 14, 42, 26, 147294)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 23, 14, 42, 26, 138251)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 23, 14, 42, 26, 137686)'}),
        ...
        u'tools.indicator': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'document': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'document_indicator'", 'to': u"orm['documents.Document']"}),
            'grade_field': ('django.db.models.fields.CharField', [], {'default': "'GRADE'", 'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indi_type': ('django.db.models.fields.CharField', [], {'default': "'Biophysical'", 'max_length': '100'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'scales': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['tools.Scale']", 'symmetrical': 'False'}),
        ...
        u'tools.indigrade': {
            'Meta': {'object_name': 'IndiGrade'},
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'grade': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "''", 'to': u"orm['tools.Grade']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'tools.tool': {
            ...
            'icon': ('django.db.models.fields.CharField', [], {'default': "'/static/img/icon_38430_coral.png'", 'max_length': '100', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'scale': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tool_scale'", 'to': u"orm['tools.Scale']"}),
        ...
        u'tools.unit': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'unit_related'", 'null': 'True', 'to': u"orm['tools.Unit']"}),
            'scale': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'unit_scale'", 'to': u"orm['tools.Scale']"}),
