...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IndiGrade.description'
        db.alter_column(u'tools_indigrade', 'description', self.gf('django.db.models.fields.CharField')(default='blort', max_length=100))


    def backwards(self, orm):
        
        # Changing field 'IndiGrade.description'
        db.alter_column(u'tools_indigrade', 'description', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 23, 14, 47, 8, 759638)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 23, 14, 47, 8, 758658)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 23, 14, 47, 8, 758338)'}),
