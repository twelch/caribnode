...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Indicator.score_field'
        db.add_column(u'tools_indicator', 'score_field', self.gf('django.db.models.fields.CharField')(default='SCORE', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Indicator.score_field'
        db.delete_column(u'tools_indicator', 'score_field')
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 15, 20, 21, 48, 43721)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 15, 20, 21, 48, 42903)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 15, 20, 21, 48, 42431)'}),
