...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Indicator.sample_field'
        db.add_column(u'tools_indicator', 'sample_field', self.gf('django.db.models.fields.CharField')(default='SAMPLE_SIZE', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Indicator.sample_field'
        db.delete_column(u'tools_indicator', 'sample_field')
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 15, 21, 56, 25, 760593)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 15, 21, 56, 25, 751982)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 15, 21, 56, 25, 751619)'}),
