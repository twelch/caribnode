...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Indicator.order'
        db.add_column(u'tools_indicator', 'order', self.gf('django.db.models.fields.PositiveIntegerField')(default=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Indicator.order'
        db.delete_column(u'tools_indicator', 'order')
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 15, 23, 8, 1, 910955)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 15, 23, 8, 1, 902828)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 15, 23, 8, 1, 902142)'}),
