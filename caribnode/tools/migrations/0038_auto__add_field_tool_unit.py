...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tool.unit'
        db.add_column(u'tools_tool', 'unit', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tool_id', null=True, to=orm['tools.Unit']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Tool.unit'
        db.delete_column(u'tools_tool', 'unit_id')
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 6, 25, 21, 23, 9, 809527)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 6, 25, 21, 23, 9, 804139)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 6, 25, 21, 23, 9, 803877)'}),
        ...
        u'tools.indicator': {
            ...
            'sample_field': ('django.db.models.fields.CharField', [], {'default': "'SAMPLE_SIZE'", 'max_length': '100'}),
            'scales': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['tools.Scale']", 'symmetrical': 'False'}),
            'score_field': ('django.db.models.fields.CharField', [], {'default': "'SCORE'", 'max_length': '100'}),
        ...
        u'tools.tool': {
            ...
            'unit': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'tool_id'", 'null': 'True', 'to': u"orm['tools.Unit']"}),
